...
Make sure that the `Resolver` record there is set to the ENS Public Resolver contract: `0x231b0Ee14048e9dCcD1d247744d114a4EB5E8E63`

:::note
The previous ENS Public Resolver contract was `0x4976fb03C32e5B8cfe2b6cCB31c09Ba78EBaBa41` which you may still see set on names
registered before 28th of March 2023.
:::
...
If it's unset, or set to a different contract address, edit it and enter the ENS Public Resolver: `0x231b0Ee14048e9dCcD1d247744d114a4EB5E8E63`
