...
### 1.2. Set the ETH Address record {#2-set-the-eth-address-record}
...
## 2. Set the Primary Name {#set-the-primary-name}
...
## 3. Verify that your Primary name works {#verify-that-your-primary-name-works}
