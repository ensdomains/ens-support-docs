...
Make sure that the `Resolver` record there is set to the ENS Public Resolver contract: `0x4976fb03C32e5B8cfe2b6cCB31c09Ba78EBaBa41`
...
If it's unset, or set to a different contract address, edit it and enter the ENS Public Resolver: `0x4976fb03C32e5B8cfe2b6cCB31c09Ba78EBaBa41`
