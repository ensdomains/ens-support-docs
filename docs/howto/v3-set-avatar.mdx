...
<table style={{borderRadius: '8px'}}>
    <thead>
        <tr>
            <th width="500px"><p>Without avatar set</p></th>
            <th width="500px"><p>With avatar set</p></th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><p><Image img="/img/avatar_notset.webp"/></p></td>
            <td><p><Image img="/img/avatar_set.webp"/></p></td>
        </tr>
    </tbody>
</table>
