...
Next, click “Add”.
Note: Not every custom key should use the reverse dot format. Keys can be named anything, but account service keys should follow a standard reverse dot convention.
