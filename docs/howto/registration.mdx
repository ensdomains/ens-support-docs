...
<BrowserWindow url="https://app.ens.domains" padding="25px" bg="#f3f4f7" img="/img/howto/v3-register-cthulu-13.png"/>
...
<BrowserWindow url="https://app.ens.domains" padding="25px" bg="#f3f4f7" img="/img/howto/v3-register-cthulu-15.png"/>
...
<BrowserWindow url="https://app.ens.domains" padding="25px" bg="#f3f4f7" img="/img/howto/v3-register-cthulu-18.png"/>