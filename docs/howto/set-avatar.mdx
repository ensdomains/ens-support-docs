...
In this tutorial you will learn how to set an avatar on your ENS name.
...
<BrowserWindow url="https://app.ens.domains" padding="25px" bg="#f2f4f7" img="/img/howto/v3-set-avatar-4.png"/>
...
<BrowserWindow url="https://app.ens.domains" padding="25px" bg="#f2f4f7" img="/img/howto/v3-set-avatar-11.png"/>
