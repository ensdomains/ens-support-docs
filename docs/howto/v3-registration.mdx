...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "125px"}}>
      <Image img="/img/howto/v3-register-1_test.png"/>
    </div>
  </p>
</BrowserWindow>
...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
      <Image img="/img/howto/v3-register-cthulu-3_new.png"/>
    </div>
  </p>
</BrowserWindow>
</TabItem>
...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
      <Image img="/img/howto/v3-register-cthulu-4_new.png"/>
    </div>
  </p>
</BrowserWindow>
</TabItem>
...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
      <Image img="/img/howto/v3-register-cthulu-5_new.png"/>
    </div>
  </p>
</BrowserWindow>
</TabItem>
...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
      <Image img="/img/howto/v3-register-cthulu-6_new.png"/>
    </div>
  </p>
</BrowserWindow>
</TabItem>
...
<BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
      <Image img="/img/howto/v3-register-cthulu-7_new.png"/>
    </div>
  </p>
</BrowserWindow>
</TabItem>
...
</BrowserWindow><BrowserWindow url="https://app.ens.domains">
  <p align="center">
    <div style={{'background-color': "#f3f4f7", 'padding': "25px"}}>
