...
// Disabled while evaluating whether the CSS solution is better than the React component
// import ThemedImage from '@site/src/components/Cthulu';
// <ThemedImage lightImage="/img/how-ens-works-light-1.png" darkImage="/img/how-ens-works-dark-1.png"/>
...
![Docusaurus themed image](/img/how-ens-works-light-1.png#gh-light-mode-only)![Docusaurus themed image](/img/how-ens-works-dark-1.png#gh-dark-mode-only)
...
![Docusaurus themed image](/img/how-ens-works-light-2.png#gh-light-mode-only)![Docusaurus themed image](/img/how-ens-works-dark-2.png#gh-dark-mode-only)
...
![Docusaurus themed image](/img/how-ens-works-light-3.png#gh-light-mode-only)![Docusaurus themed image](/img/how-ens-works-dark-3.png#gh-dark-mode-only)
...
![Docusaurus themed image](/img/how-ens-works-light-4.png#gh-light-mode-only)![Docusaurus themed image](/img/how-ens-works-dark-4.png#gh-dark-mode-only)
...
For more information on registering .eth names, fees, and renewals, see:
 - <Link to="/docs/core/registration/"><b>Core Concepts:</b> Registration & Renewals</Link>
:::
