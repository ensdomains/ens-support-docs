...
The temporary price premium attached starts at $100 million and declines exponentially to $0 over the 21 days.

# Why have a temporary auction?
The temporary auction was conceived of as a way to prevent ENS names from being sniped by bots immediately when they expired, which was initially a significant problem.
