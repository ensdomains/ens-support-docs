...
ENS names go far beyond that, however, allowing you to add all kinds of records to it from social media links, to profile pictures, custom records to decentralized websites.
Giving you a name that can serve as your complete Web3 identity.
...
:::info Supported Protocols
 - **IPFS & IPNS**  
 *InterPlanetary FileSystem & It's name resolution service*
