...
| **CANNOT_APPROVE** | The approved "subname renewal manager" for the name can no longer be updated. See the <Link to="/docs/dev-basics/namewrapper/approved-operators">Approved Operators</Link> section for more information. |
