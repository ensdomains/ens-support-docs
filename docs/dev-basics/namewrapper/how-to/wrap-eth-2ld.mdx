...
<BrowserWindow url="app.ens.domains">
  <div style={{'padding':'25px'}}>
    <Image img="/img/namewrapper-howto-wrap-eth-2ld-1.png"/>
  </div>
</BrowserWindow>
...
<BrowserWindow url="app.ens.domains">
  <div style={{'padding':'25px'}}>
    <Image img="/img/namewrapper-howto-wrap-eth-2ld-2.png"/>
  </div>
</BrowserWindow>
...
<BrowserWindow url="app.ens.domains">
  <div style={{'padding':'25px'}}>
    <Image img="/img/namewrapper-howto-wrap-eth-2ld-3.png"/>
  </div>
</BrowserWindow>
...
<BrowserWindow url="app.ens.domains">
  <div style={{'padding':'25px'}}>
    <Image img="/img/namewrapper-howto-wrap-eth-2ld-4.png"/>
  </div>
</BrowserWindow>
...
<BrowserWindow url="app.ens.domains">
  <div style={{'padding':'25px'}}>
    <Image img="/img/namewrapper-howto-wrap-eth-2ld-5.png"/>
  </div>
</BrowserWindow>
