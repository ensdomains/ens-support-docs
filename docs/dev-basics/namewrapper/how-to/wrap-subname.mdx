...
Also, you will now have access to the Permissions (Fuses) section in the manager. Read the <Link to="/docs/dev-basics/namewrapper/fuses">Fuses</Link> page for more information, and the <Link to="/docs/dev-basics/namewrapper/how-to/change-permissions">Change Permissions</Link> page for instructions on how to change permissions on wrapped names.
