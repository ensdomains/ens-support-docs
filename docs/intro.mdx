...
<div class="docs-card-container">
  <div class="row row-cols-1 row-cols-md-2a g-4">
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column">
        <a href="/docs/core/what-is-ens" class="card-link"><span></span></a>
    ...
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column" >
        <a href="/docs/howto/registration" class="card-link"><span></span></a>
    ...
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column">
        <a href="/docs/dev-basics" class="card-link"><span></span></a>
  ...
  <div class="row row-cols-1 row-cols-md-2a g-4">
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column">
        <a href="/docs/core" class="card-link"><span></span></a>
    ...
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column" >
        <a href="/docs/faq" class="card-link"><span></span></a><h2><img src="/img/svg/056-file-3.svg" width="18px"/> Support FAQ</h2>
    ...
    <div class="col">
      <div class="card card-body h-100 w-500 d-flex flex-column">
        <a href="/docs/howto" class="card-link"><span></span></a>
