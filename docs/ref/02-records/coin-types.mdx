...
# Coin Types
ENS supports a wide variety of cryptocurrency addresses all of which can be added to your ENS name, and used to send and receive funds[^1]
...
:::caution
The blockchain must integrate ENS in order for send/receive to work
:::
