...
ENS supports several coin types, all of which can be added to your ENS name’s records. You can view the supported cryptocurrency addresses at the <Link to="https://github.com/ensdomains/address-encoder"><b>ensdomains:address-encoder</b><Link> page on Github.
