...
| [**Content hash**](/core/records/content-hash) | This record links your ENS name to a decentralized website. Supporting browsers can then resolve and load that website directly from your ENS name. |