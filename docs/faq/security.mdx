...
<i>Except,</i> what the website does is spawn a transaction that either directly transfers one of your NFT's out or adds a `Token Approval` which gives another wallet full access to one of your NFT collections.

:::caution
<i>Always</i> review the transaction that appears in your wallet and make sure that it does what you expect it to.
:::
