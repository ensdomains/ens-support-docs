...
> [**Resolver:** ENS Public Resolver](../../names/records/resolver.mdx#ens-public-resolver)
...
> [**Address:** Set an Address record](../../names/records/address.mdx#set-an-address-record)
