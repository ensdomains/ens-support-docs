...
keywords: [things to do with your ens, things to do with your ens name, everything you can do with your ens, everything you can do with your ens name, what can i use ens for]
---
...
If you'd like to add wallet addresses to your ENS name you can follow our guide here:
 - [**How-To:** Add a Wallet Address](/docs/howto/v3-add-wallet-address)
...
<div class="container protocol-items">
  <div class="row row-no-gutters" style={{'padding':'1rem 1rem 1rem 1rem','columnGap':'1rem'}}>
    ...
    <div class="col-sm-8" style={{'maxWidth':'88%','position':'relative'}}>The Arweave network is like Bitcoin, but for data: A permanent and decentralized web inside an open ledger.</div>
  </div>
</div>
<br/>
<div class="container protocol-items">
...
:::info
  ...
  - [**How-To:** Create a Decentralized Website](/docs/howto/v3-decentralized-website)
:::

<br/>

## Connect metadata to your Web3 identity
Your ENS name can also store metadata like your e-mail address, website and social media usernames so people can easily find them.
...
If you'd like to add social media links to your ENS name you can follow our guide here:
 - [**How-To:** Create a Decentralized Website](/docs/howto/v3-set-record)
 - [**How-To:** Set a Twitter name](/docs/howto/set-twitter-name)
:::
...
:::info
If you'd like to add a website or e-mail record to your ENS name you can follow our guide here:
 - [**How-To:** Set a Record](/docs/howto/v3-set-record)
:::
...
If you'd like to add a custom service key to your ENS name you can follow our guide here:
 - [**How-To:** Add a Custom Service Key](/docs/howto/v3-add-custom-record.mdx)
:::