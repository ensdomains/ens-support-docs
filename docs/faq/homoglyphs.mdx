...
## Warning signs
Fortunately, there are many different types of warning signs you can look for. Services will often have indicators for name containing unusual characters,
...
rush to buy it, take some time to copy/paste the name into a `Unicode Analyzer` and _verify_ that the name is what it pretends to be.