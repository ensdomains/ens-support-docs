...
## Build a website
In this section we'll create a basic website to deploy to IPFS using <Link to="https://heavens.tools"><b>Heaven's Tools</b></Link> excellent Web3 website builder.
:::tip
If you already have a website you'd like to upload, proceed to [**Set up a GitHub repository**](#set-up-a-github-repository)
:::

### Create the website
Go to <Link to="https://heavens.tools"><b>Heaven's Tools</b></Link> website and use the drag and drop building blocks to create your site.
...
<BrowserWindow url="github.com">
  <Image img="/img/tutorials/decentralized_website_5.png" />
</BrowserWindow>
