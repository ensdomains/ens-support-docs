...
This guide will use IPNS (InterPlanetary Name System) to reference IPFS content instead of directly with a CID that would change once content is updates. To learn more about hosting unchanging content see: [Host in Parallel DNS and ENS static content from IPFS](/dnstoens/importguide/host-in-parallel)
