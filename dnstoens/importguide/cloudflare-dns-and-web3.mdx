...
Cloudflare DNS is also able to offer DNSSEC, which is one of the [Requirements for DNS to ENS Integration](/requirements-dns-to-ens)
...
*<mark>Note: Before changing DNS providers, if DNSSEC is turned on at the current DNS host, you should turn the feature off before migrating DNS hosts.</mark>*
...
![Alt text](https://dnstoens.com/images/cf-image1.png "Save new nameservers")

Next, update the Nameservers at your registrar. In this example, we are migrating from Namecheap DNS services to Cloudflare.

![Alt text](https://dnstoens.com/images/cf-image4.png "Update nameservers")

## Step 4: Enable DNSSEC in Cloudflare for your domain

![Alt text](https://dnstoens.com/images/cf-image17.png "Enable DNSSEC")
...
![Alt text](https://dnstoens.com/images/cf-image6.png "DS Record")
...
![Alt text](https://dnstoens.com/images/cf-image5.png "DS Key at Registrar")

Your DNS records are now hosted through Cloudflare. If you would like to test using Cloudflare’s IPFS Gateway, refer to: [Serve Blockchain Content through DNS records](/importguide/4-index)
