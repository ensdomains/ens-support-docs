...
Other guides found on this site rely on using Cloudflare as the DNS host provider. Cloudflare offers a free-tier level of DNS Hosting that also comes with an optional IPFS gateway solution. The IPFS gateway feature is used in the [Host in Parallel DNS and ENS content from IPFS](/importguide/4-index) and [Query Blockchain Content through DNS Records](/importguide/3-index) guides. 

`**Note: When changing DNS providers, be sure your records are set up correctly on the new DNS provider. Failing to do so could cause email routing to stop, or your website to not display. Please proceed after making necessary notes about your current DNS configuration.**`
...
![Alt text](https://dnstoens.com/images/1-index-sc1.png "Turn on DNSSEC")
...
![Alt text](https://dnstoens.com/images/1-index-sc2.png "Set TXT Record")
...
![Alt text](https://dnstoens.com/images/1-index-sc3.png "DNS Ready for ENS Import")
...
* [DNS and ENS Further Development](/future-dns-ens) - Test DNSSEC authentication and record resolution.